...
export default function OurServiceCard({ title, description, href, Icon }: ServiceCardType) {
    return (
        <div
            className={[
        ...
        >
            ...
            <h3 className="relative text-2xl font-semibold text-brand-cream">{title}</h3>
            ...
            <Link
                href={href}
                className="relative mt-10 inline-flex rounded-md bg-brand-gold px-6 py-2 text-sm font-semibold text-brand-navy hover:bg-brand-gold-3 active:bg-brand-gold-2 transition"
            >
                Get A Quote
            </Link>
        </div>
